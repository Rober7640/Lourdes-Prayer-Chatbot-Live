...
Second post-purchase upsell offering the Archangel Michael Pendant ($49) with a St. Michael Prayer Card downsell ($19). This upsell fires **after Upsell 1 resolves** — regardless of whether the user bought the medal, candle, or declined everything.
...
└─────────────────────────────────────────────────────────────────────────────┘
        ...
        ▼                                         ▼
┌───────────────────┐               ┌─────────────────────────────────┐
│  ACCEPT PENDANT   │               │      PHASE: DOWNSELL_2          │
│    (3 msgs)       │               │         (3 msgs)                │
│       ↓           │               │              ↓                  │
│  SHIPPING FORM    │               │   PRAYER CARD OFFER ($19)       │
│       ↓           │               │   [Accept]        [Decline]     │
│  THANK YOU        │               │       ↓                ↓        │
│  (pendant)        │               │  THANK YOU        THANK YOU     │
└───────────────────┘               │  (prayer card)    (close)       │
                                    └─────────────────────────────────┘
```
...
### PHASE: DOWNSELL_2
**Messages:** 3 | **UI:** Prayer Card Offer

#### For Others:
```
"I understand."
"One small thing — would you like me to send a St. Michael Prayer Card? Something {personName} can keep in a wallet, a pocket, or by their bed."
"Many people tell us they read it every morning."
```

#### For Self:
```
"I understand."
"One small thing — would you like me to send a St. Michael Prayer Card? Something you can keep close — in a wallet, a pocket, by your bed."
"Many people tell us they read it every morning."
```
...
```
┌─────────────────────────────────────────┐
│   🛡️ ST. MICHAEL PRAYER CARD            │
│   For {personName}                      │
│                                         │
│   The prayer of protection, printed     │
│   on a keepsake card. Free shipping.    │
│                                         │
│             $19                          │
│                                         │
│  [Yes — Send the Prayer Card]           │
│  [No thank you]                         │
└─────────────────────────────────────────┘
```
...
### PHASE: ACCEPT_PRAYER_CARD
**Messages:** 2

#### For Others:
```
"Thank you, {userName}. The prayer card will be on its way shortly."
"A small thing — but the right words at the right time can carry someone through the hardest days."
```

#### For Self:
```
"Thank you, {userName}. The prayer card will be on its way shortly."
"A small thing — but the right words at the right time can carry you through the hardest days."
```

→ **THANK YOU CARD (prayer card)**

---

### PHASE: DECLINE_PRAYER_CARD
**Messages:** 2
...
### Prayer Card Purchase
**Trigger:** Accept prayer card | **UI:** ThankYouCard variant="prayer_card"

```
┌─────────────────────────────────────────┐
│           🛡️                            │
│  "Your Order is Confirmed"              │
│  Words of protection, on the way        │
├─────────────────────────────────────────┤
│  [card img]  St. Michael Prayer Card    │
│              For: {personName} — $19    │
├─────────────────────────────────────────┤
│  WHAT HAPPENS NEXT                      │
│  ✦ Prayer card shipped                  │
...
├─────────────────────────────────────────┤
│  [Sister Marie portrait]                │
│  "May Michael's prayer be a comfort     │
│   to {personName} — every single day."  │
├─────────────────────────────────────────┤
│  Need help? support@lourdes-healing.com │
│  [Return to Home]                       │
└─────────────────────────────────────────┘
...
| Downsell (optional) | 3 | 20-22 |
| Accept/Decline card | 2 | 22-24 |
...
| Decline pendant → Accept prayer card | Prayer card purchase | Prayer Card |
| Decline pendant → Decline prayer card | Full decline | Close (blessing) |
...
| Prayer + Medal + Prayer Card | $35 | $59 | $19 | $113 |
| Prayer + Candle | $35 | $19 | — | $54 |
| Prayer + Candle + Pendant | $35 | $19 | $49 | $103 |
| Prayer + Candle + Prayer Card | $35 | $19 | $19 | $73 |
| Prayer + Pendant | $35 | — | $49 | $84 |
| Prayer + Prayer Card | $35 | — | $19 | $54 |
...
type Upsell2UiHint =
  ...
  | "show_prayer_card_offer"
  | "show_shipping_form"
  | "show_thank_you_pendant"
  | "show_thank_you_prayer_card"
...
```json
{
  ...
  "flags": {
    ...
    "prayer_card_offer_shown": false,
    "prayer_card_accepted": false,
    "prayer_card_declined": false
  }
}
```
